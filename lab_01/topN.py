...
# This script loads captions from a .vtt file and prints the first few lines.
# It can be used to verify that the captions are loaded correctly before further processing.